...
public class MainActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		personService = ((SuperPhoneBookApplication)getApplication()).getPersonService();
		...
		ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,nameList);
